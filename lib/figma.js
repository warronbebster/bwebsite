...
const createComponent = (component, svgMap, imageFills, componentMap) => {
	...
	const visitNode = (node, parent, lastVertical, indent) => {
		...
		if (node.layoutAlign) {
			...
			// if (parent.layoutMode == 'VERTICAL') styles.margin = parent.itemSpacing + 'px 0px';
			// if (parent.layoutMode == 'HORIZONTAL') styles.margin = '0px ' + parent.itemSpacing + 'px ';
		}
		...
		//above just prints the opening tag for whatever
