...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-10w6x69");
    			add_location(div, file$2, 452, 10, 11460);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(451:8) {#if params.project == i}",
    		ctx
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "nextIndicators svelte-10w6x69");
    			add_location(div, file$2, 463, 16, 11855);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(/*held*/ ctx[3] || /*navOpen*/ ctx[5] ? "paused" : "no") + " svelte-10w6x69"));
    			add_location(div0, file$2, 458, 18, 11688);
    			attr_dev(div1, "id", "currentIndicator");
    			attr_dev(div1, "class", "svelte-10w6x69");
    			add_location(div1, file$2, 457, 16, 11642);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*held, navOpen*/ 40 && div0_class_value !== (div0_class_value = "" + (null_to_empty(/*held*/ ctx[3] || /*navOpen*/ ctx[5] ? "paused" : "no") + " svelte-10w6x69"))) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "svelte-10w6x69");
    			add_location(div, file$2, 455, 16, 11575);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(455:14) {#if params.story > p}",
    		ctx
    	});
    ...
    // (454:12) {#each stories as story, p}
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(454:12) {#each stories as story, p}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const story = new Story({
    			props: {
    				...
    				? true
    				: false,
    				next: /*next*/ ctx[6].project == /*i*/ ctx[39] && /*next*/ ctx[6].story == /*j*/ ctx[42]
    				? true
    				: false,
    				prev: /*prev*/ ctx[7].project == /*i*/ ctx[39] && /*prev*/ ctx[7].story == /*j*/ ctx[42]
    				? true
    				: false,
    				nextCover: /*i*/ ctx[39] == /*nextProject*/ ctx[8]
    				? /*j*/ ctx[42] == /*activeStories*/ ctx[1][/*nextProject*/ ctx[8]]
    					? true
    					: false
    				: /*i*/ ctx[39] == /*prevProject*/ ctx[9]
    					? /*j*/ ctx[42] == /*activeStories*/ ctx[1][/*prevProject*/ ctx[9]]
    						? true
    						: false
    					: false
    			},
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*next*/ 64) story_changes.next = /*next*/ ctx[6].project == /*i*/ ctx[39] && /*next*/ ctx[6].story == /*j*/ ctx[42]
    			? true
    			: false;

    			if (dirty[0] & /*prev*/ 128) story_changes.prev = /*prev*/ ctx[7].project == /*i*/ ctx[39] && /*prev*/ ctx[7].story == /*j*/ ctx[42]
    			? true
    			: false;

    			if (dirty[0] & /*nextProject, activeStories, prevProject*/ 770) story_changes.nextCover = /*i*/ ctx[39] == /*nextProject*/ ctx[8]
    			? /*j*/ ctx[42] == /*activeStories*/ ctx[1][/*nextProject*/ ctx[8]]
    				? true
    				: false
    			: /*i*/ ctx[39] == /*prevProject*/ ctx[9]
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(470:8) {#each stories as story, j}",
    		ctx
    	});
    ...
    // (434:4) {#each projectArray as { name, stories }
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			? "currentProject"
    			: "") + "\n        " + (/*i*/ ctx[39] == /*nextProject*/ ctx[8]
    			? "nextProject"
    			: "") + "\n        " + (/*i*/ ctx[39] == /*prevProject*/ ctx[9]
    			? "prevProject"
    			: "") + "\n        " + " svelte-10w6x69");

    			attr_dev(div, "style", div_style_value = "\n        " + (/*held*/ ctx[3] && (/*i*/ ctx[39] == /*params*/ ctx[0].project || /*i*/ ctx[39] == /*nextProject*/ ctx[8] || /*i*/ ctx[39] == /*prevProject*/ ctx[9])
    			? "transform: rotateY(" + (Math.min(Math.max(/*gesture_gap*/ ctx[2] / 4.2, -90), 90) + (/*i*/ ctx[39] == /*nextProject*/ ctx[8] ? 90 : 0) + (/*i*/ ctx[39] == /*prevProject*/ ctx[9] ? -90 : 0)) + "deg);"
    			: "") + "\n        " + (/*params*/ ctx[0].project == /*i*/ ctx[39]
    			? "transform-origin: center " + /*swipeDirection*/ ctx[4] + ";"
    			: "") + "\n        " + (/*nextProject*/ ctx[8] == /*i*/ ctx[39]
    			? "transform-origin: center left;"
    			: "") + "\n        " + (/*prevProject*/ ctx[9] == /*i*/ ctx[39]
    			? "transform-origin: center right;"
    			: "") + "\n        " + (!/*held*/ ctx[3]
    			? "transition: left .5s ease, transform .5s ease;"
    			: "transition: left 0s; transform 0s") + "\n        ");

    			add_location(div, file$2, 436, 6, 10590);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			if (if_block) if_block.m(div, null);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*params, nextProject, prevProject*/ 769 && div_class_value !== (div_class_value = "project " + /*i*/ ctx[39] + "\n        " + (/*params*/ ctx[0].project == /*i*/ ctx[39]
    			? "currentProject"
    			: "") + "\n        " + (/*i*/ ctx[39] == /*nextProject*/ ctx[8]
    			? "nextProject"
    			: "") + "\n        " + (/*i*/ ctx[39] == /*prevProject*/ ctx[9]
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(434:4) {#each projectArray as { name, stories }",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", button0_class_value = "" + (null_to_empty(/*held*/ ctx[3] ? "grabbing" : "no") + " svelte-10w6x69"));
    			add_location(button0, file$2, 406, 4, 9607);
    			attr_dev(button1, "id", "nextButton");
    			attr_dev(button1, "class", button1_class_value = "" + (null_to_empty(/*held*/ ctx[3] ? "grabbing" : "no") + " svelte-10w6x69"));
    			add_location(button1, file$2, 419, 4, 10058);

    			attr_dev(main, "style", main_style_value = "left: " + (/*held*/ ctx[3]
    			? Math.max(Math.min(/*gesture_gap*/ ctx[2], window.innerWidth), -window.innerWidth)
    			: 0) + "px;\n    " + (/*held*/ ctx[3]
    			? "transition: left 0s ease;"
    			: "transition: left .5s ease;"));

    			attr_dev(main, "class", "svelte-10w6x69");
    			add_location(main, file$2, 399, 2, 9328);
    			...
    			attr_dev(div, "class", "svelte-10w6x69");
    			add_location(div, file$2, 396, 0, 9178);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*held*/ 8 && button0_class_value !== (button0_class_value = "" + (null_to_empty(/*held*/ ctx[3] ? "grabbing" : "no") + " svelte-10w6x69"))) {
    				attr_dev(button0, "class", button0_class_value);
    			}

    			if (!current || dirty[0] & /*held*/ 8 && button1_class_value !== (button1_class_value = "" + (null_to_empty(/*held*/ ctx[3] ? "grabbing" : "no") + " svelte-10w6x69"))) {
    			...
    			if (!current || dirty[0] & /*held, gesture_gap*/ 12 && main_style_value !== (main_style_value = "left: " + (/*held*/ ctx[3]
    			? Math.max(Math.min(/*gesture_gap*/ ctx[2], window.innerWidth), -window.innerWidth)
    			: 0) + "px;\n    " + (/*held*/ ctx[3]
    			? "transition: left 0s ease;"
    			: "transition: left .5s ease;"))) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function gestureDown(e) {
    		...
    		if (e.type == "touchstart") {
    			...
    			//if it's a mouse
    			gesture_start = e.pageX; // gesture_start.pageY = Math.round(e.changedTouches[0].pageY);
    	...
    	function gestureMove(e) {
    		...
    		if (e.type == "touchmove") {
    			...
    			//if it's a mouse
    			gesture_active = e.pageX; // gesture_active.pageY = Math.round(e.changedTouches[0].pageY);
    		} // gesture_active.pageY = e.pageY;

    		$$invalidate(2, gesture_gap = gesture_active - gesture_start);
