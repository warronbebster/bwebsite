    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 88, 6, 1755);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ol, "class", "svelte-1jyasvt");
    			add_location(ol, file$1, 85, 2, 1704);
    			attr_dev(nav, "class", "svelte-1jyasvt");
    			add_location(nav, file$1, 74, 0, 1512);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
