...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(94:2) {#if showStoryContent}",
    		ctx
    	});
    ...
    // (412:4) {#each projectArray as { name, stories }
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(412:4) {#each projectArray as { name, stories }",
    		ctx
    	});
