    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 85, 6, 1669);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ol, "class", "svelte-13ku50t");
    			add_location(ol, file$1, 82, 2, 1618);
    			attr_dev(nav, "class", "svelte-13ku50t");
    			add_location(nav, file$1, 71, 0, 1426);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
