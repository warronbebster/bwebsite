    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 94, 6, 1889);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ol, "class", "svelte-1sonp8e");
    			add_location(ol, file$1, 91, 2, 1838);
    			attr_dev(nav, "class", nav_class_value = "" + (null_to_empty(/*navOpen*/ ctx[1] ? "open" : "closed") + " svelte-1sonp8e"));
    			add_location(nav, file$1, 79, 0, 1608);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*navOpen*/ 2 && nav_class_value !== (nav_class_value = "" + (null_to_empty(/*navOpen*/ ctx[1] ? "open" : "closed") + " svelte-1sonp8e"))) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 439, 10, 11700);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 450, 16, 12095);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 445, 18, 11928);
    			attr_dev(div1, "id", "currentIndicator");
    			attr_dev(div1, "class", "svelte-n01c88");
    			add_location(div1, file$2, 444, 16, 11882);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "svelte-n01c88");
    			add_location(div, file$2, 442, 16, 11815);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 431, 6, 10714);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			if (if_block) if_block.m(div, null);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$2, 424, 2, 10445);
    			...
    			add_location(div, file$2, 400, 0, 9880);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
